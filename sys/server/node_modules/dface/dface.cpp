...
void selectSql(const FunctionCallbackInfo<Value>& args)
{
	...
	{
		::ThrowException("'selectSql' function expected 'databaseFilename' to be a non-empty string");
		return;
	}

	if (sQuery == _T(""))
	{
		::ThrowException("'selectSql' function expected 'query' to be a non-empty string");
		return;
	}
