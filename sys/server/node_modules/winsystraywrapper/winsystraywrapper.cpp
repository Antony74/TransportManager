...
Handle<Value> run(const Arguments& args)
{
	...
	if (brc)
	{
		CSysTrayMenu::Create(sIconPath, sTitle, shellExecuteInfo.hProcess, menuObject);
...
Handle<Value> stop(const Arguments& args)
{
	...
	CSysTrayMenu::GetSoleInstance()->StopWrappedProcess();
...
void init(Handle<Object> exports)
{
	...
	exports->Set(String::NewSymbol("poll"),  FunctionTemplate::New(poll)->GetFunction());
