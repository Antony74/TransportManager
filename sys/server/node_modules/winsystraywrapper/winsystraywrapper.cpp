...
Handle<Value> run(const Arguments& args)
{
	...
	Local<Value> vHideHostWin = args[0]->ToObject()->Get(String::NewSymbol("hideHostWin"));
	Local<Value> vErrorCodes  = args[0]->ToObject()->Get(String::NewSymbol("errorCodes"));
...
Handle<Value> showLog(const Arguments& args)
{
	HandleScope scope;

	if (args.Length())
	{
		ThrowException(Exception::Error(String::New("'showLog' function does not take any arguments")));
		return scope.Close(Undefined());
	}
...
void init(Handle<Object> exports)
{
	...
	exports->Set(String::NewSymbol("showLog"), FunctionTemplate::New(showLog)->GetFunction());
